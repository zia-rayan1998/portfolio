...
--
-- Name: blogs Admins can create blogs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can create blogs" ON public.blogs FOR INSERT TO authenticated WITH CHECK (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "Admins can delete blogs" ON public.blogs FOR DELETE TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role));
...
--
-- Name: blogs Admins can read all blogs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can read all blogs" ON public.blogs FOR SELECT TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "Admins can update blogs" ON public.blogs FOR UPDATE TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role));
